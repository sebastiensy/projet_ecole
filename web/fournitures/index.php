			...
			<div id="sse50">
				<div id="sses50">
					<ul>
						<?php
						$i = 0;
						$titres = array("Ecriture", "Trousse", "Crayons - Feutres", "Cahiers", "Prot�ge-cahiers", "Classeurs", "Petit mat�riel", "Arts plastiques", "Papier dessin", "Dictionnaires - Calculatrices");
						$db = new DB_connection();
						$requete = "SELECT DISTINCT(categorie) FROM Sous_categorie order by id_scat";
						$db->DB_query($requete);
						while($rub = $db->DB_object())
