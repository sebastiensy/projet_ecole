...
{ 
	...
	<div id="formulaire_contacte">
		...
		<p><label class="lab_cont" for="message">Texte :</label><textarea style="width:300px; height:150px;" id="idees" name="message" onblur="champVide(this)" maxlength="256"><?php echo $message;?></textarea></p>
