...
?>
	...
	<form method="post" action="ajouter_article.php" name="f1" id="maj">
		<table width="90%" align="center">
			...
			<tr >
				<td >
						<span><input type="text" name="ref" value="<?php echo $ref;?>" required></span>
				
				</td>
				<td >
					
								<span><input size="30" type="text" name="desc" value="<?php echo $desc;?>"required></span>
					
				</td>
				<td >
					
								<span><input size="10" type="text" name="prix" value="<?php echo $prix;?>" required></span>
