...
?> 
		...
		<p> <label class="inscription"  for="nbrenfant">Nombre d'enfants:</label> <input type="text" name="nbrenfant" id="nbrenfant" class="spinner" min="1" max="10" value="<?php echo $nbrenfant;?>"/> </p>
