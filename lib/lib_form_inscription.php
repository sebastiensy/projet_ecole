...
?> 
		...
		<p> <label class="inscription" for="nbrenfant">Nombre d'enfants:</label> <input type="number" name="nbrenfant" id="nbrenfant" onblur="champVide(this)" size="1" min="1" max="10" value="<?php echo $nbrenfant; ?>"/></p>
